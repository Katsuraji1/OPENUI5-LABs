sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/Worklist/app", ".html");
		...
		return Opa5.extend("zjblessons.Worklist.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/Worklist/localService/mockserver"], function (mockserver) {
